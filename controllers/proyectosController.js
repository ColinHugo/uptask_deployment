...
exports.nuevoProyecto = async ( req, res ) => {
    ...
    // Para leer los datos de un formulario, se debe habilitar una librería llamada body-parser, de lo contrario dirá null
    ...
    if( errores.length > 0 ) {
        ...
        // Todas las interacciones de la BD son por medio del modelo
        const usuarioId = res.locals.usuario.id;
